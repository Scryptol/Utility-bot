...
module.exports.execute = async(client, message, args) => {    
    ...
    if(isNaN(args[1]) && isNaN(parseFloat(args[0]))) {
        ...
        .setDescription(`You need to say a valid number of coins to dice roll on!`)
        .setColor('DARK_RED')
    ...
    if(randomCoins > 3) {
        if(args[0]) {
                ...
                .setDescription(`You won ${args[0]} coins from the dice roll!`)
                .setColor('GREEN')
        ...
        if(args[0]) {
                ...
                .setDescription(`You lost ${args[0]} coins from the dice roll!`)
                .setColor('DARK_RED')
...
module.exports.config = {
    name: 'diceroll',
    description: 'Roll a dice for some coins!',
    cooldown: 60,
    category: 'Economy'
}